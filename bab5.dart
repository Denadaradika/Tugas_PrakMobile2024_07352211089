...
/*****  ✨ Codeium Command ⭐  *****/
  /// Refreshes the list of books by re-running [fetchBooks] and setting the
  /// result as the new value of [books].
  ///
  /// This is typically used after a book has been added, edited, or removed
  /// to ensure the list of books displayed is up-to-date.
/**  fbd64cf3-6eab-4576-a9ec-c8a14d340dd6  ***/
  void refreshBooks() {
    setState(() {
      books = fetchBooks();
    });
